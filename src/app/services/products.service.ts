...
import { ICartItem, IProduct, IProductCategory } from '../model';
...
export class ProductsService {
  ...
  private cartProductsState: ICartItem[] = [
    {
      id: 1,
  ...
  get cartProducts(): ReadonlyArray<ICartItem> {
    return this.cartProductsState;
  }
